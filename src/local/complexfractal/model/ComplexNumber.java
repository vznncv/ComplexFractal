...
public final class ComplexNumber {
            ...
            while (m.find()) {
                ...
                if (m.group("space") == null) {
                    ...
                    if (m.group("sign") != null) {
                        ...
                        realPart += sign * Double.valueOf(m.group("real"));
                        // default sign
                        sign = 1;
                        ...
                        if (!m.group("imag").isEmpty()) {
                            imagePart += sign * Double.valueOf(m.group("imag"));
                        } else {
                            // only i
                            imagePart += sign;
                        }
    ...
    public String toString() {
        if (real != 0) {
            if (imag != 0)
                return String.format(Locale.ENGLISH, "%f %+fi", real, imag);
            else
                return String.format(Locale.ENGLISH, "%f", real);
        } else {
            if (imag != 0)
                return String.format(Locale.ENGLISH, "%fi", imag);
            else
                return "0.0";
        }
    }
